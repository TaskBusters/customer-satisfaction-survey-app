...
const fields = [
  ...
  // Awareness
  {
    ...
    instruction:
      "INSTRUCTIONS: Please click on the buttons that best correspond to your answer on the Citizen's Charter (CC) Questions. The Citizen's Charter is an official document that reflects the services of a government agency/office including its requirements, fees, and processing times among others.",
    name: "ccAwareness",
    type: "radio",
  ...
  // SQD matrix
  {
    ...
    instruction:
      "INSTRUCTIONS: For SQD 0-8, please click on the designated buttons that best correspond to your answer.",
    name: "sqdRatings",
    type: "matrix",
