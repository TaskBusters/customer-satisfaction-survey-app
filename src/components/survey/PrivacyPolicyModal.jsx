  ...
  const privacyContent = [
    {
      ...
      body: t("privacyPolicy.section1Body"),
    },
    {
      title: t("privacyPolicy.section2Title"),
      body: t("privacyPolicy.section2Body"),
    },
    {
      title: t("privacyPolicy.section3Title"),
      body: t("privacyPolicy.section3Body"),
    },
    {
      title: t("privacyPolicy.section4Title"),
      body: t("privacyPolicy.section4Body"),
    },
    {
      title: t("privacyPolicy.section5Title"),
      body: t("privacyPolicy.section5Body"),
    },
    {
      title: t("privacyPolicy.section6Title"),
      body: t("privacyPolicy.section6Body"),
    },
    {
      title: t("privacyPolicy.section7Title"),
      body: t("privacyPolicy.section7Body"),
    },
    {
      title: t("privacyPolicy.section8Title"),
      body: t("privacyPolicy.section8Body"),
    },
  ]
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
      <div className="bg-white rounded-xl shadow-lg w-[90vw] max-w-2xl p-8 flex flex-col">
        <h2 className="text-3xl font-bold mb-6 text-center text-blue-700">{t("survey.privacyPolicy")}</h2>
