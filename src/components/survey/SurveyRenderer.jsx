...
export default function SurveyRenderer({
  ...
  const translateOption = (fieldName, optionValue, originalLabel) => {
    ...
    if (fieldName === "gender") {
      ...
      if (optionValue === "na") return t("survey.preferNotToSay");
    }
